...
enum {
    MLX5_HCA_CAP_GENERAL_OBJECT_TYPES_ENCRYPTION_KEY = 4096, // BIT(0xc),
    MLX5_HCA_CAP_GENERAL_OBJECT_TYPES_IPSEC = 8192, // BIT(0x13),
    MLX5_HCA_CAP_GENERAL_OBJECT_TYPES_SAMPLER = 1048576, // BIT(0x20),
};
